...
class RewriteRenderer extends BaseRenderer {
  public _renderer: (type: string) => SVGAElement | any;
  ...
  constructor(
    ...
    function addMarker(id: string, options: any) {
      const attrs = assign(
        {
          fill: 'black',
          strokeWidth: 1,
     ...
     * @param stroke 边界颜色
     */
    function marker(type: string, fill: string, stroke: string) {
     ...
     * @param attrs
     */
    function drawDiamond(parentGfx: SVGElement, width: number, height: number, attrs?: any) {
      const x_2 = width / 2;
      const y_2 = height / 2;
      const points = [
        { x: x_2, y: 0 },
     ...
     * 绘制钻线条
     * @param parentGfx svg图标
     * @param waypoints 端点数组
     * @param attrs
     */
    function drawLine(parentGfx: SVGElement, waypoints: Point[], attrs?: any) {
     ...
     * @param attrs
     */
    function drawPath(parentGfx: SVGElement, d: any, attrs?: any): SVGPathElement {
      attrs = computeStyle(attrs, ['no-fill'], {
        strokeWidth: 2,
        stroke: 'black',
      });
     ...
     * @param attrs
     */
    function drawMarker(type: string, parentGfx: SVGAElement, path: any, attrs?: any) {
    ...
    function as(type: string) {
      return function (parentGfx: SVGAElement, element: Element) {
     ...
     * @param parentGfx svg图标
     */
    function renderEventContent(element: Element, parentGfx: SVGAElement) {
     ...
     * @param options
     */
    function renderLabel(parentGfx: SVGAElement, label: string, options: any) {
      options = assign(
        {
          size: {
            width: 100,
     ...
     * @param align
     */
    function renderEmbeddedLabel(parentGfx: SVGAElement, element: Element, align: string) {
     ...
     * @param element
     */
    function renderExternalLabel(parentGfx: SVGAElement, element: Element) {
      const box = {
        width: 90,
        height: 30,
     ...
     * @param element
     */
    function renderLaneLabel(parentGfx: SVGAElement, text: string, element: Element) {
     ...
     * @param connection
     */
    function createPathFromConnection(connection: Element) {
     ...
     * @param taskMarkers
     */
    function attachTaskMarkers(parentGfx: SVGAElement, element: Element, taskMarkers?: string[]) {
     ...
     * @param element
     */
    function renderDataItemCollection(parentGfx: SVGAElement, element: Element) {
    ...
    const handlers: Record<string, any> = (this.handlers = {
      'bpmn:Event': function (
        ...
        return drawCircle(parentGfx, element.width, element.height, 0, attrs);
      },
      'bpmn:StartEvent': function (parentGfx: SVGAElement, element: Element) {
        ...
        const circle: SVGCircleElement = renderer('bpmn:Event')(parentGfx, element, attrs);
      ...
      'bpmn:LinkEventDefinition': function (parentGfx: SVGAElement, event: Element, options: any) {
      ...
      'bpmn:ErrorEventDefinition': function (parentGfx: SVGAElement, event: Element, options: any) {
      ...
      'bpmn:EndEvent': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:TerminateEventDefinition': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:IntermediateEvent': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:Activity': function (parentGfx: SVGAElement, element: Element, attrs: any) {
        attrs = attrs || {};
        if (!('fillOpacity' in attrs)) {
          attrs.fillOpacity = DEFAULT_FILL_OPACITY;
        }
      ...
      'bpmn:Task': function (parentGfx: SVGAElement, element: Element) {
        const attrs = {
      ...
      'bpmn:ServiceTask': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:UserTask': function (parentGfx: SVGAElement, element: Element) {
        const task = renderer('bpmn:Task')(parentGfx, element);
        const x = 15;
        const y = 12;
      ...
      'bpmn:ManualTask': function (parentGfx: SVGAElement, element: Element) {
        const task = renderer('bpmn:Task')(parentGfx, element);
      ...
      'bpmn:SendTask': function (parentGfx: SVGAElement, element: Element) {
        const task = renderer('bpmn:Task')(parentGfx, element);
      ...
      'bpmn:ReceiveTask': function (parentGfx: SVGAElement, element: Element) {
        const semantic = getSemantic(element);
        const task = renderer('bpmn:Task')(parentGfx, element);
        let pathData;
      ...
      'bpmn:ScriptTask': function (parentGfx: SVGAElement, element: Element) {
        const task = renderer('bpmn:Task')(parentGfx, element);
      ...
      'bpmn:BusinessRuleTask': function (parentGfx: SVGAElement, element: Element) {
        const task = renderer('bpmn:Task')(parentGfx, element);
      ...
      'bpmn:SubProcess': function (parentGfx: SVGAElement, element: Element, attrs: any) {
        attrs = assign(
          {
            fill: getFillColor(element, defaultFillColor),
            stroke: getStrokeColor(element, defaultTaskColor),
      ...
      'bpmn:AdHocSubProcess': function (parentGfx: SVGAElement, element: Element) {
        return renderer('bpmn:SubProcess')(parentGfx, element);
      },
      'bpmn:Transaction': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:CallActivity': function (parentGfx: SVGAElement, element: Element) {
        return renderer('bpmn:SubProcess')(parentGfx, element, {
          strokeWidth: 5,
        });
      },
      'bpmn:Participant': function (parentGfx: SVGAElement, element: Element) {
        const attrs = {
      ...
      'bpmn:Lane': function (parentGfx: SVGAElement, element: Element, attrs: any) {
        const rect = drawRect(
          parentGfx,
          element.width,
          element.height,
      ...
      'bpmn:InclusiveGateway': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:ExclusiveGateway': function (parentGfx: SVGAElement, element: Element) {
        const diamond = renderer('bpmn:Gateway')(parentGfx, element);
      ...
      'bpmn:ComplexGateway': function (parentGfx: SVGAElement, element: Element) {
        const diamond = renderer('bpmn:Gateway')(parentGfx, element);
      ...
      'bpmn:ParallelGateway': function (parentGfx: SVGAElement, element: Element) {
        const diamond = renderer('bpmn:Gateway')(parentGfx, element);
      ...
      'bpmn:EventBasedGateway': function (parentGfx: SVGAElement, element: Element) {
        const semantic = getSemantic(element);
        const diamond = renderer('bpmn:Gateway')(parentGfx, element);
        /* outer circle path */
      ...
      'bpmn:Gateway': function (parentGfx: SVGAElement, element: Element) {
        const attrs = {
      ...
      'bpmn:SequenceFlow': function (parentGfx: SVGAElement, element: Element) {
        ...
        let source;
        if ((element as Connection).source) {
          source = (element as Connection)?.source?.businessObject;
      ...
      'bpmn:Association': function (parentGfx: SVGAElement, element: Element, attrs: any) {
        const semantic = getSemantic(element);
        const fill = getFillColor(element, defaultFillColor),
          stroke = getStrokeColor(element, defaultTaskColor);
        attrs = assign(
        ...
        return drawLine(parentGfx, (element as Connection).waypoints, attrs);
      },
      'bpmn:DataInputAssociation': function (parentGfx: SVGAElement, element: Element) {
        const fill = getFillColor(element, defaultFillColor),
          stroke = getStrokeColor(element, defaultTaskColor);
      ...
      'bpmn:DataOutputAssociation': function (parentGfx: SVGAElement, element: Element) {
        const fill = getFillColor(element, defaultFillColor),
          stroke = getStrokeColor(element, defaultTaskColor);
        return renderer('bpmn:Association')(parentGfx, element, {
          markerEnd: marker('association-end', fill, stroke),
      ...
      'bpmn:MessageFlow': function (parentGfx: SVGAElement, element: Element) {
        const semantic = getSemantic(element),
          di = getDi(element);
        const fill = getFillColor(element, defaultFillColor),
          stroke = getStrokeColor(element, defaultTaskColor);
      ...
      'bpmn:DataObject': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:DataInput': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:DataOutput': function (parentGfx: SVGAElement, element: Element) {
        const arrowPathData = pathMap.getRawPath('DATA_ARROW');
        // page
        const elementObject = renderer('bpmn:DataObject')(parentGfx, element);
        /* output arrow path */
      ...
      'bpmn:DataStoreReference': function (parentGfx: SVGAElement, element: Element) {
      ...
      'bpmn:BoundaryEvent': function (parentGfx: SVGAElement, element: Element) {
        const semantic = getSemantic(element),
      ...
      'bpmn:Group': function (parentGfx: SVGAElement, element: Element) {
        return drawRect(parentGfx, element.width, element.height, TASK_BORDER_RADIUS, 0, {
          stroke: getStrokeColor(element, defaultTaskColor),
          strokeWidth: 1,
      ...
      label: function (parentGfx: SVGAElement, element: Element) {
        return renderExternalLabel(parentGfx, element);
      },
      'bpmn:TextAnnotation': function (parentGfx: SVGAElement, element: Element) {
        const style = {
          fill: 'none',
          stroke: 'none',
        };
      ...
      ParticipantMultiplicityMarker: function (parentGfx: SVGAElement, element: Element) {
      ...
      SubProcessMarker: function (parentGfx: SVGAElement, element: Element) {
        const markerRect = drawRect(parentGfx, 14, 14, 0, 0, {
          strokeWidth: 1,
          fill: getFillColor(element, defaultFillColor),
          stroke: getStrokeColor(element, defaultTaskColor),
        });
      ...
      ParallelMarker: function (parentGfx: SVGAElement, element: Element, position: Position) {
        const markerPath = pathMap.getScaledPath('MARKER_PARALLEL', {
          xScaleFactor: 1,
          yScaleFactor: 1,
          containerWidth: element.width,
      ...
      SequentialMarker: function (parentGfx: SVGAElement, element: Element, position: Position) {
      ...
      CompensationMarker: function (parentGfx: SVGAElement, element: Element, position: Position) {
      ...
      LoopMarker: function (parentGfx: SVGAElement, element: Element, position: Position) {
      ...
      AdhocMarker: function (parentGfx: SVGAElement, element: Element, position: Position) {
   ...
   * @param connection
   */
  public drawConnection<E extends Base>(visuals: SVGElement, connection: E): SVGPolylineElement {
   ...
   * @param element
   */
  public drawShape<E extends Base>(parentGfx: SVGElement, element: E): SVGRectElement {
  ...
  /**
   * 获取连接线位置 <E extends Base>(connection: E)
   * @param connection
   */
  public getConnectionPath(): string | undefined {
    return undefined;
  }
   ...
   * @param shape
   */
  public getShapePath<E extends Base>(shape: E): string | undefined {
   ...
   * @param colors
   */
  public setElementColors(element: Base | string, colors: object): void {
    const svg = this._elementRegistry?.getGraphics(element);
    if (!svg) return;
    const paths = svgSelect(svg, '.djs-visual');
    paths && paths.childNodes.forEach((el: SVGAElement) => svgAttr(el, colors));
  }
}
