<template>
  <el-form :size="size">
    <el-form-item>
      <el-radio v-model="radioValue" :label="1"> {{$t('cron.everySecond')}}，{{$t('cron.allowedWildcards')}} [, - * /] </el-radio>
    </el-form-item>
    ...
    <el-form-item class="start">
      <el-radio v-model="radioValue" :label="4" style="margin-right: 20px">{{ $t('cron.designate') }}{{ $t('cron.seconds') }}</el-radio>
      <div class="flex">
...
<script setup name="CronSecond" lang="ts">
